...
```
Help Me to Write of Tryhackme room walkthrough up in real time
1. Platform for Medium story
2. I will share you the walkthrough in parts As solve or discover each part of lab, you need to improvise it & make it Seo & search optimistic for google and your self to recommend my walkthrough of this room 

Rules set:
1. Rewrite and improvise the give part. The walkthrough should be 1st person like written by me and search & seo optimized for medium like story 
2. the walkthrough should match similar tone, don't use emoji , don't use - like sign that obvious to detect for human it written by ai
3. dont over-explain anything,dont provide me any hint, map, extra suggestion, overview that help me to solve the lab or help me lab bez this is for my self improvement and for helping other if they stuck need help solving this room / lab / machine

Here is the Room info below:


Name: Lian_Yu
Lab Discription: https://tryhackme.com/room/lianyu


I will provide u in parts and there are someplace marked with image where i add image those places are being tag like this <img>

dont suggest me what to do next Im sharing u just u have to improve that showcase each and every commands so a beginner and intermediate can solve this room by reading this walkthrough just explain points not much but can be understood
